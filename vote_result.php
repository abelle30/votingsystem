    ...
    <div id="row">
		...
		?>
		  ...
		  <div class = "alert alert-info">
			...
			<div class = "alert alert-success">
			<div class="panel-heading"><center>FIRST-YEAR REPRESENTATIVE</center></div>
			<br />
			<?php
			...
			<div class = "alert alert-info" >
			<div class="panel-heading"><center>SECOND-YEAR REPRESENTATIVE</center></div>
			<br />
			<?php
				if(!$_SESSION['sg_id'])
					{
			...
			<div class = "alert alert-success">
			<div class="panel-heading"><center>THIRD-YEAR REPRESENTATIVE</center></div>
			<br />
			<?php
				if(!$_SESSION['vtr_id'])
					{
			...
			<div class = "alert alert-info">
			<div class="panel-heading"><center>FOURTH-YEAR REPRESENTATIVE</center></div>
			<br />
			<?php
				if(!$_SESSION['tas_id'])
					{
