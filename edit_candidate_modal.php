				...
				<form method = "post" enctype = "multipart/form-data">	
					...
					<div class="form-group">
						...
						<select class = "form-control" name = "position" value = "<?php echo $row ['position']?>">
								...
								<option>P.R.O.</option>
								<option>First-Year Representative</option>
								<option>Second-Year Representative</option>
								<option>Third-Year Representative</option>
								<option>Fourth-Year Representative</option>
