...
<body>
    ...
    <heading class="voters_heading">
        <center><h1>Registered Second Year Representative Candidates</h1>
           <center>
                ...
                <option disabled selected>Second Year Representative</option>
                <option value = "tyr.php">Third Year Representative</option>
                <option value = "fryr.php">Fourth Year Representative</option>
                </select>
            </center>
