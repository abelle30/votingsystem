    ...
    <heading class="voters_heading">
        <center><h1>Registered Entertainment Advisor Candidates</h1>
           <center>
                ...
                <option value = "ss.php">Treasurer</option>
				<option value = "pb.php">P.R.O.</option>
                <option disabled selected>First Year Representative</option>
                <option value = "tr.php">Second Year Representative</option>
                <option value = "vtr.php">Third Year Representative</option>
                <option value = "sg.php">Fourth Year Representative</option>
