    ...
    <heading class="voters_heading">
        <center><h1>Registered Treasurer Candidates</h1>
           <center>
                ...
                <option value = "candidates/sec.php">Secretary</option>
				<option value = "candidates/tre.php">Treasurer</option>
				<option value = "candidates/pro.php">P.R.O.</option>
                <option value = "candidates/fyr.php">First Year Representative</option>
                <option value = "candidates/syr.php">Second Year Representative</option>
                <option value = "candidates/tyr.php">Third Year Representative</option>
                <option value = "candidates/fryr.php">Fourth Year Representative</option>
                </select>
            </center>
